...
public final class RoleTestData extends BaseNamedEntityTestData<Role> {
    ...
    public static final Pageable PAGEABLE = PageRequest.of(0, 10, Sort.by(Meta.Role.NAME));
